...
export function Avatar({
  ...
  // Always a circle. A `fill` escape hatch existed for one caller — the chip's
  // straight-edged slab cap — and went with it; a photograph squared off
  // against that edge is exactly what the operator reported.
