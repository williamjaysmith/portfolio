...
- [ ] T068 Documentation sync — `CLAUDE.md` active-feature block and status, `specs/002-family-week-calendar/plan.md` Progress (Phase 3 tick), memory notes; final commit(s) on `002-family-week-calendar`
